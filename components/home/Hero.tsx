...
const slides: Slide[] = [
  {
    ...
    textColor: "text-white", // Slide 1: Texto Blanco
  ...
  return (
    <section className="relative w-full h-[90vh] overflow-hidden bg-neutral-900">
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center p-6 text-center z-20">
            <div className="max-w-4xl space-y-6">
              ...
              {/* Título: Color forzado desde la configuración del slide */}
              <h1 
                className={`text-4xl md:text-6xl lg:text-7xl font-bold leading-tight drop-shadow-md ${slide.textColor || "text-white"}`}
              >
                {slide.title}
              </h1>

              {/* Subtítulo: Color forzado */}
              <p 
                className={`text-lg md:text-xl font-medium max-w-2xl mx-auto drop-shadow-sm opacity-90 ${slide.textColor || "text-white"}`}
              >
                {slide.subtitle}
              </p>
              ...
              <div className="pt-6">
                <Link
                  href={slide.ctaHref}
                  className={`
                    inline-block px-8 py-3 rounded-full text-lg font-bold transition-transform duration-300 hover:scale-105 shadow-lg
                    ${
      ...
      {/* =========================
          ...
          (hidden md:block -> Ocultas en Mobile, Visibles en Desktop)
         ========================= */}
      ...
      {/* =========================
          Indicadores (Dots)
          (flex -> Visibles siempre, incluido Mobile)
         ========================= */}
        ...
        {slides.map((_, index) => (
          <button
            ...
            className={`
              ...
              ${index === currentSlide ? "bg-white w-8 h-3" : "bg-white/50 hover:bg-white/80 w-3 h-3"}
            `}
