        ...
        <section className='max-w-4xl mx-auto space-y-12'>
          <div className='text-center space-y-6'>
            ...
            <p className='opacity-90'>
              ...
              Ofrezco servicio remoto para Colombia, Latinoamérica, España, USA,
              Canadá y más.
            </p>
          </div>
          ...
          <div className='bg-[var(--bg-card)] border border-[var(--brand-primary)]/30 rounded-2xl p-8 flex flex-col md:flex-row gap-6 items-start shadow-sm relative overflow-hidden'>
            ...
            <div className='space-y-3 relative z-10'>
              ...
              <p className='text-sm md:text-base opacity-80'>
                Trabajo con un número limitado de proyectos. Prefiero cumplir
                bien cada compromiso, mantener comunicación clara y acompañar
                cada proyecto de principio a fin sin delegarlo a terceros.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto'>
            ...
            <div className='bg-[var(--bg-card)] border border-[var(--border-subtle)] hover:border-[var(--brand-primary)]/50 transition-colors rounded-3xl p-8 space-y-6 shadow-sm group'>
              ...
              <p className='opacity-80 leading-relaxed'>
                Revisión profunda del estado real de tu sitio web para detectar
                vulnerabilidades, cuellos de botella y oportunidades de mejora
                (WPO).
              </p>
              <ul className='space-y-3 opacity-90'>
                <li className='flex items-start gap-3'>
                  <CheckCircle className='w-5 h-5 text-[var(--brand-primary)] shrink-0 mt-0.5' />{' '}
                  Revisión de Core, hosting y dominio.
                </li>
                <li className='flex items-start gap-3'>
                  <CheckCircle className='w-5 h-5 text-[var(--brand-primary)] shrink-0 mt-0.5' />{' '}
                ...
                <li className='flex items-start gap-3'>
                  <CheckCircle className='w-5 h-5 text-[var(--brand-primary)] shrink-0 mt-0.5' />{' '}
                  Requiere acceso al entorno técnico.
                </li>
              </ul>
              <div className='pt-4 border-t border-[var(--border-subtle)]'>
                <p className='text-sm font-medium text-[var(--brand-primary)]'>
                  * El costo de la auditoría se descuenta del servicio final si
                  decides realizar el trabajo técnico conmigo.
                </p>
              </div>
            </div>
            ...
            <div
              id='consultoria'
              className='bg-[var(--bg-card)] border border-[var(--border-subtle)] hover:border-[var(--brand-primary)]/50 transition-colors rounded-3xl p-8 space-y-6 shadow-sm group'
            >
              <div className='w-14 h-14 bg-[var(--bg-tertiary)] group-hover:bg-[var(--brand-primary)]/10 rounded-2xl flex items-center justify-center transition-colors'>
              ...
              <p className='opacity-80 leading-relaxed'>
                Sesión de orientación y diagnóstico 1 a 1 donde resolvemos dudas
                específicas, evaluamos ideas y definimos la arquitectura o
                camino a seguir.
              </p>
              <ul className='space-y-3 opacity-90'>
                <li className='flex items-start gap-3'>
                  <CheckCircle className='w-5 h-5 text-[var(--brand-primary)] shrink-0 mt-0.5' />{' '}
                  Primera sesión gratuita (60 mins).
                </li>
                <li className='flex items-start gap-3'>
                  <CheckCircle className='w-5 h-5 text-[var(--brand-primary)] shrink-0 mt-0.5' />{' '}
                  Videollamada (Meet / Teams / Zoom).
                </li>
                <li className='flex items-start gap-3'>
                  <CheckCircle className='w-5 h-5 text-[var(--brand-primary)] shrink-0 mt-0.5' />{' '}
                  No requiere compartir accesos.
                </li>
              </ul>
              <div className='pt-4 border-t border-[var(--border-subtle)]'>
                <p className='text-sm font-medium text-[var(--text-secondary)] opacity-80'>
                  Las sesiones posteriores tienen un costo basado en el tiempo
                  de dedicación y el alcance del requerimiento.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className='max-w-[1200px] mx-auto px-5'>
            <div className='grid grid-cols-1 lg:grid-cols-12 gap-12 items-start'>
              ...
              <div className='lg:col-span-5 space-y-6 pt-4 lg:sticky lg:top-24'>
                <h2 className='text-left !my-0 text-4xl md:text-5xl'>
                  Comencemos
                  <br />
                ...
                <p className='text-lg opacity-90 max-w-md'>
                  Rellena este formulario con los detalles de lo que necesitas.
                  Te responderé lo más pronto posible para coordinar nuestra
