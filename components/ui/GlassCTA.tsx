...
/* =====================================================
   GlassCTA
   - Llamada a la acción con efecto Spotlight y Cristal
...
export default function GlassCTA ({
  ...
  // Lógica de Spotlight (Lógica Sensible Blindada)
  ...
  // Normalización de ruta i18n
  const localizedHref = buttonHref.startsWith(`/${lang}`) 
    ? buttonHref 
    : `/${lang}${buttonHref.startsWith('/') ? '' : '/'}${buttonHref}`;
